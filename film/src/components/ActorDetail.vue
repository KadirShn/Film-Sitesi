<template>
  <div>
    <v-container>
      <v-row>
            ...
            <v-card :elevation="hover ? 16 : 2" :class="{ 'on-hover': hover }">
              ...
              <v-card-text>
                <v-row class="mx-0 d-flex justify-center">
                  <v-btn class="mx-2" fab dark small color="#3b5998"
                    :href="'https://facebook.com/' + socialDetails.facebook_id">
                    <v-icon dark>
                      fab fa-facebook-f
                    </v-icon>
                  </v-btn>
                  <v-btn class="mx-2" fab dark small color="#E1306C"
        ...
        <v-col cols="12" sm="8">
          ...
          <v-row>
            <v-col cols="12">
              <v-btn text>
                <v-icon color="#e366c1">fas fa-birthday-cake</v-icon>
              </v-btn>
          ...
          <h4 class="mt-1 purple--text">Popüler Filmleri</h4>
          <v-row>
      ...
      <h2 class="mt-2 purple--text ">Diğer Filmleri</h2>
      <ul class=" pl-5 mt-8">
