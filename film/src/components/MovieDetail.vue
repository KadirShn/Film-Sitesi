    ...
    <v-container>
      <v-row>
        ...
        <v-col cols="12" sm="8">
          ...
          <div class="mt-5">
            <h2 class="mt-5 grey--text text--darken-3">Öne Çıkan Oyuncular </h2>
          ...
          <v-dialog v-model="dialog" persistent max-width="800px">
            <template v-slot:activator="{on, attrs}">
              <v-btn tile color="#a261c7" v-bind="attrs" v-on="on" @click.prevent="openYouTubeModel">
            ...
            <v-card>
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="#a261c7" text @click="dialog = flase">Close</v-btn>
              </v-card-actions>
            </v-card>
          </v-dialog>
          <v-btn tile color="#a261c7" class="ml-2">
