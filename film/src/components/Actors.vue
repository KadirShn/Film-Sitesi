<template>
  <div class="mx-3">
    <h2 class="mt-2 purple--text">Popüler Oyuncular</h2>
    <v-container fluid>
      <v-row>
        ...
        <v-col cols="12" class="d-flex justify-center mt-5">
          <v-btn class="mx-2" fab dark small color="#731f78" v-on:click.prevent="previous()">
            <v-icon dark>
              fas fa-step-backward
            </v-icon>
          </v-btn>
          <v-btn class="mx-2" fab dark small color="#731f78" v-on:click.prevent="next()">
            <v-icon dark>
              fas fa-step-forward
            </v-icon>
          </v-btn>
